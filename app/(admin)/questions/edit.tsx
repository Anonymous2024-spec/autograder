  ...
  return (
    ...
    >
        ...
        <View style={styles.answerPill}>
          {correctIndex >= 0 ? (
            <>
              ...
              <Text style={styles.answerPillText}>Correct answer: Option {LABELS[correctIndex]}</Text>
            </>
          ) : (
            <>
              <Ionicons name="alert-circle-outline" size={13} color="rgba(255,255,255,0.6)" />
              <Text style={[styles.answerPillText, { color: "rgba(255,255,255,0.6)" }]}>No correct answer marked</Text>
            </>
          )}
        </View>
      </LinearGradient>
      ...
      >
        ...
        <Text style={styles.optionsHint}>Tap the radio button to mark the correct answer</Text>
...
const styles = StyleSheet.create({
  ...
  optionLabelBox: { width: 28, height: 28, borderRadius: Radius.sm, justifyContent: "center", alignItems: "center" },
