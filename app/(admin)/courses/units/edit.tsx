...
export default function EditCourseUnit() {
  const router = useRouter();
  const insets = useSafeAreaInsets();
  const { id } = useLocalSearchParams();

  const [name, setName] = useState("Introduction to Programming");
  const [code, setCode] = useState("PROG101");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.headerTitle}>Edit Course Unit</Text>
            <Text style={styles.headerSub}>Update unit details</Text>
          </View>
        </View>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.infoNote}>
          ...
          <Text style={styles.infoNoteText}>
            Any changes made here will be reflected in the course unit and all
      ...
      >
        ...
        >
          <LinearGradient
            colors={[Colors.cardGreen, "#059669"]}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 0 }}
...
const styles = StyleSheet.create({
  ...
  infoNote: {
    ...
    borderWidth: 1,
    borderColor: Colors.cardGreen + "20",
  },
  infoNoteText: {
    flex: 1,
    fontSize: FontSize.xs,
